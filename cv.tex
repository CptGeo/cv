...
\leftheader{%
  {\LARGE\bfseries\sffamily George Kalyvianakis, B.Sc.}

  \makefield{\faEnvelope[regular]}{\href{mailto:george.kalyvianakis@gmail.com}{\texttt{george.kalyvianakis@gmail.com}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/george-kalyvianakis/}{\texttt{george-kalyvianakis}}}
  
  \makefield{\faGithub}{\href{https://github.com/CptGeo}{\texttt{CptGeo}}}
  \makefield{\faGlobe}{\url{https://kalyvianakis.com/}}
  % You can use a tabular here if you want to line up the fields.
  \\
  \\
  \makefield{\faAddressCard}{\texttt{Brno Zidenice, Czech Republic}}
}
